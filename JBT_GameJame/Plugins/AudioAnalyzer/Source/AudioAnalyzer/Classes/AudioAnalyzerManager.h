...
UENUM(BlueprintType)
	enum class EAA_SpectrumType : uint8
	{
...
UENUM(BlueprintType)
	enum class EAA_ChannelSelectionMode : uint8
	{
...
UENUM(BlueprintType)
	enum class EAA_AudioFormat : uint8
	{
...
UENUM(BlueprintType)
	enum class EAA_AudioDepth : uint8
	{
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|Capturer|Initialization", meta = (AdvancedDisplay = "5"))
		bool InitCapturerAudioEx(int32 SampleRate=44100, EAA_AudioDepth BitDepth=EAA_AudioDepth::B_16, EAA_AudioFormat AudioFormat= EAA_AudioFormat::Signed_Int, float AudioBufferSeconds =1.f,
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|Loopback|Initialization", meta = (AdvancedDisplay = "5"))
		bool InitLoopbackAudioEx(int32 NumChannels = 2, int32 SampleRate = 44100, EAA_AudioDepth BitDepth = EAA_AudioDepth::B_16, EAA_AudioFormat AudioFormat = EAA_AudioFormat::Signed_Int,
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|Stream|Initialization", meta = (AdvancedDisplay = "6"))
		bool InitStreamAudio(int32 NumChannels=2, int32 SampleRate=44100, EAA_AudioDepth BitDepth=EAA_AudioDepth::B_16, EAA_AudioFormat AudioFormat=EAA_AudioFormat::Signed_Int,
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|OVR|Initialization", meta = (AdvancedDisplay = "4"))
		bool InitOVRAudio(int32 SampleRate = 48000, EAA_AudioFormat AudioFormat = EAA_AudioFormat::Signed_Int, float AudioBufferSeconds = 1.f, bool InitPlaybackDevice = false,
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|Capturer|Utils")
		void GetCapturerDevicesAudioInfo(FString& CapturerDeviceName, int32& CapturerSampleRate, int32& CapturerNumChannels, int32& CapturerBufferSamples, EAA_AudioFormat& CapturerFormat, int32& CapturerBitDepth,
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|OVR|Utils")
		void GetOVRDevicesAudioInfo(FString& CapturerDeviceName, int32& CapturerSampleRate, int32& CapturerNumChannels, int32& CapturerBufferSamples, EAA_AudioFormat& CapturerFormat, int32& CapturerBitDepth,
			FString& PlayerDeviceName, int32& PlayerSampleRate, int32& PlayerNumChannels, int32& PlayerBufferSamples, EAA_AudioFormat& PlayerFormat, int32& PlayerBitDepth);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "AudioAnalyzerManager|Analysis|Initialization")
		void InitPitchTrackingConfig(EAA_ChannelSelectionMode ChannelMode, int32 Channel, float TimeWindow=0.02f, float Threshold=0.19f);
