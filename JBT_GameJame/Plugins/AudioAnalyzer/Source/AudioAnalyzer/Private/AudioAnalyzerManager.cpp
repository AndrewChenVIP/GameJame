...
void UAudioAnalyzerManager::GetPlayerDeviceAudioInfo(FString& DeviceName, int32& SampleRate, int32& NumChannels, int32& BufferSamples, EAA_AudioFormat& Format, int32& BitDepth)
{
	...
	Format = static_cast<EAA_AudioFormat>(deviceInfo.format);
...
{
	return InitCapturerAudioEx(44100, EAA_AudioDepth::B_16, EAA_AudioFormat::Signed_Int, 1.0, false, 0, 0, 0);
}

bool UAudioAnalyzerManager::InitCapturerAudioEx(int32 SampleRate, EAA_AudioDepth BitDepth, EAA_AudioFormat AudioFormat, float AudioBufferSeconds, 
	bool InitPlaybackDevice, int32 PeriodSizeInFrames, int32 PeriodSizeInMilliseconds, int32 Periods)
{
	int32 bitdepthDecoded = 16;
	if (BitDepth == EAA_AudioDepth::B_32)
	{
		bitdepthDecoded = 32;
	}
...
void UAudioAnalyzerManager::GetCapturerDevicesAudioInfo(FString& CapturerDeviceName, int32& CapturerSampleRate, int32& CapturerNumChannels, int32& CapturerBufferSamples, EAA_AudioFormat& CapturerFormat, int32& CapturerBitDepth, 
														FString& PlayerDeviceName, int32& PlayerSampleRate, int32& PlayerNumChannels, int32& PlayerBufferSamples, EAA_AudioFormat& PlayerFormat, int32& PlayerBitDepth)
{
	...
	CapturerFormat = static_cast<EAA_AudioFormat>(deviceInfo.format);
	...
	PlayerFormat = static_cast<EAA_AudioFormat>(playerDeviceInfo.format);
...
{
	return InitLoopbackAudioEx(2, 44100, EAA_AudioDepth::B_16, EAA_AudioFormat::Signed_Int, 1.0, 0, 0, 0);
}

bool UAudioAnalyzerManager::InitLoopbackAudioEx(int32 NumChannels, int32 SampleRate, EAA_AudioDepth BitDepth, EAA_AudioFormat AudioFormat, float AudioBufferSeconds, 
...
void UAudioAnalyzerManager::GetLoopbackDeviceAudioInfo(FString& DeviceName, int32& SampleRate, int32& NumChannels, int32& BufferSamples, EAA_AudioFormat& Format, int32& BitDepth)
{
...
/*                     STREAM                      */
/***************************************************/
bool UAudioAnalyzerManager::InitStreamAudio(int32 NumChannels, int32 SampleRate, EAA_AudioDepth BitDepth, EAA_AudioFormat AudioFormat, float AudioBufferSeconds,
	bool InitPlaybackDevice, int32 PeriodSizeInFrames, int32 PeriodSizeInMilliseconds, int32 Periods)
{
	int32 bitdepthDecoded = 16;
	if (BitDepth == EAA_AudioDepth::B_32)
...
void UAudioAnalyzerManager::GetStreamDevicesAudioInfo(FString& PlayerDeviceName, int32& PlayerSampleRate, int32& PlayerNumChannels, int32& PlayerBufferSamples, EAA_AudioFormat& PlayerFormat, int32& PlayerBitDepth)
{
...
bool UAudioAnalyzerManager::InitOVRAudio(int32 SampleRate, EAA_AudioFormat AudioFormat, float AudioBufferSeconds, bool InitPlaybackDevice,
	int32 PeriodSizeInFrames, int32 PeriodSizeInMilliseconds, int32 Periods)
{
...
void UAudioAnalyzerManager::GetOVRDevicesAudioInfo(FString& CapturerDeviceName, int32& CapturerSampleRate, int32& CapturerNumChannels, int32& CapturerBufferSamples, EAA_AudioFormat& CapturerFormat, int32& CapturerBitDepth,
	FString& PlayerDeviceName, int32& PlayerSampleRate, int32& PlayerNumChannels, int32& PlayerBufferSamples, EAA_AudioFormat& PlayerFormat, int32& PlayerBitDepth)
{
...
void UAudioAnalyzerManager::InitAmplitudeConfig(EAA_ChannelSelectionMode ChannelMode, int32 Channel, int32 NumTimeBands, float TimeWindow)
{
...
void UAudioAnalyzerManager::GetAmplitudeSection(TArray<float>& Amplitude, EAA_ChannelSelectionMode ChannelMode, int32 Channel, float StartTime, float EndTime, int Resolution)
{
	if (ChannelMode == EAA_ChannelSelectionMode::Split_all)
	{
...
void UAudioAnalyzerManager::GetAmplitudeSectionByChannel(UChannelFResult*& AmplitudeByChannel, float StartTime, float EndTime, int Resolution)
{
	if (Resolution > 0)
	{
		_AACore.getAmplitudeSection(_amplitudeByChannel->getContainer(), (uint8)EAA_ChannelSelectionMode::Split_all, 0, StartTime, EndTime, Resolution);
		AmplitudeByChannel = _amplitudeByChannel;
	}
	else
	{
...
void UAudioAnalyzerManager::InitSpectrumConfig(EAA_SpectrumType type,
												EAA_ChannelSelectionMode ChannelMode,
												int32 Channel, 
												int32 NumFreqBands, 
												float TimeWindow, 
												int32 HistorySize, 
												...
												int32 NumPeaks)
{
	if (_AACore.hasValidAudio())
	{
		if (type == EAA_SpectrumType::ST_Log)
		{
...
void UAudioAnalyzerManager::InitSpectrumConfigWLimits(EAA_ChannelSelectionMode ChannelMode, 
														int32 Channel, 
...
void UAudioAnalyzerManager::InitBeatTrackingConfig(EAA_ChannelSelectionMode ChannelMode, int32 Channel, float TimeWindow, int32 HistorySize, bool CalculateBPM, int32 BPMHistorySize, float Threshold)
{
	if (_AACore.hasValidAudio())
	{
...
void UAudioAnalyzerManager::InitBeatTrackingConfigWLimits(EAA_ChannelSelectionMode ChannelMode, int32 Channel, const TArray<FVector2D>& BandLimits, float TimeWindow, int32 HistorySize, bool CalculateBPM, int32 BPMHistorySize, float Threshold)
{
	if (_AACore.hasValidAudio())
	{
...
void UAudioAnalyzerManager::InitPitchTrackingConfig(EAA_ChannelSelectionMode ChannelMode,
													int32 Channel,
													float TimeWindow,
													float Threshold)
{
